"""
Django settings for dsfsdfsdgsg_2 project.
...
ROOT_URLCONF = 'dsfsdfsdgsg_2.urls'
...
WSGI_APPLICATION = 'dsfsdfsdgsg_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dsfsdfsdgsg_2 API",
    "DESCRIPTION": "API documentation for dsfsdfsdgsg_2 App",
    "VERSION": "v1",
}
